...
while True:
    ...
    while now < (start + 25):
        ...
        bobber = pyautogui.screenshot(
            f"monitor_bobber_{now}.png", region=(monitor_left, monitor_top, 100, 100)
        )
        ...
        comparison_bobber = bobbed_averages + (
            STANDARD_DEVIATIONS * numpy.std(bobber_image_averages)
        )
